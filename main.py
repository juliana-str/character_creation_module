...
def attack(char_name: str, char_class: str) -> str:
    """Подсчитывает урон, нанесенный противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Подсчитывает количество блокированных очков урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Добавляет очков в соответствии с специальными возможностями."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Проводит тренировку/атаку/защиту/применение специальных возможностей."""
    if char_class == 'warrior':
